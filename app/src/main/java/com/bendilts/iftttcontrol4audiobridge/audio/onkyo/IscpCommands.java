...
public class IscpCommands
{
    ...
    {
        String retVal = "";
        if(commandMap_.containsKey(command))
    ...
    public static  String getVolumeCmdStr(int volume){return String.format("MVL%02X", volume);}

    /** station is in the format 995 or 1027 for 99.5FM or 102.7FM */
    public static String getTuneCmdStr(int station){return String.format("TUN%04d0", station);}
