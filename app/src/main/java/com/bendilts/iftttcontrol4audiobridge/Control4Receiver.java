...
public class Control4Receiver extends Control4Device {
    ...
    public Control4Receiver() {
        ...
        inputs.add(new AudioInput(3, "TV Audio", "tv", 0, R.drawable.tv));
    ...
    public void sendChannelVol(AudioOutput output, int volume) throws IOException {
        notifyListeners();
    ...
    private void sendChannelInput(AudioOutput output, AudioInput input) throws IOException {
        notifyListeners();
    ...
    public void sendChannelMute(AudioOutput output, boolean mute) throws IOException {
        notifyListeners();
        sendToDevice(String.format("c4.amp.mute %02x %02x", output.index, mute ? 1 : 0));
    }

    public void setAudio(AudioOutput output, AudioInput input, int volume) throws IOException {
